...
image_path = '../transformer/Dataset/Flicker8k_Dataset/'
dir_Flickr_text = '../transformer/Dataset/Flickr8k.token.txt'
...
all_captions = []
cap_file = '../transformer/captions.pickle'
...
all_img_name_vector = []
img_name = '../transformer/img_name.pickle'
...
def map_func(img_name, cap):
    img_tensor = np.load('../transformer/'+img_name.decode('utf-8') + '.npy')
    image = load_pre_image('../transformer/'+img_name.decode('utf-8'))
